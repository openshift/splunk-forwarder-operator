...
build: isclean envtest
	...
	docker build . -f $(FORWARDER_DOCKERFILE) --build-arg VERSION=$(FORWARDER_VERSION) --build-arg VERSION_HASH=$(FORWARDER_HASH) -t $(FORWARDER_IMAGE_URI)
	docker tag $(FORWARDER_IMAGE_URI) $(FORWARDER_IMAGE_URI_LATEST)
	docker build . -f $(HEAVYFORWARDER_DOCKERFILE) --build-arg VERSION=$(FORWARDER_VERSION) --build-arg VERSION_HASH=$(FORWARDER_HASH) -t $(HEAVYFORWARDER_IMAGE_URI)
	docker tag $(HEAVYFORWARDER_IMAGE_URI) $(HEAVYFORWARDER_IMAGE_URI_LATEST)
...
push:
	...
	docker push $(HEAVYFORWARDER_IMAGE_URI)
	docker push $(HEAVYFORWARDER_IMAGE_URI_LATEST)
