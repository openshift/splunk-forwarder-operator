...
csv['spec']['install']['spec']['deployments'][0]['spec']['template']['spec']['containers'][0]['image'] = splunk_forwarder_operator_image

# Update the versions to include git hash:
csv['metadata']['name'] = "splunk-forwarder-operator.v%s" % full_version
csv['spec']['version'] = full_version
csv['spec']['replaces'] = "splunk-forwarder-operator.v%s" % prev_version
...
csv_filename = "splunk-forwarder-operator.v%s.clusterserviceversion.yaml" % full_version
